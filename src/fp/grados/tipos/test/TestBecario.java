...
public class TestBecario {
	public static void main(String[] args) {
		...
		testsetFechaComienzoExcepcional();
		testSetEmail();
	}
	...
	private static void testConstructor1Excepcional() {
		System.out.println("\n================================ Probando el primer constructor, fecha de inicio incorrecta");
	...
	private static void testConstructor2Excepcional() {
		System.out.println("\n================================ Probando el segundo constructor, fecha de inicio incorrecta");
	...
	private static void testsetFechaComienzoExcepcional() {
		System.out
	...
	private static void testConstructor1(String dni, String nombre,
		...
		try {
			...
			System.out.println("**************************** Se ha capturado la excepción ExcepcionBecarioNoValido");
	...
	private static void testsetFechaComienzo(Becario b, LocalDate fechaComienzo) {
		...
		try {
			System.out.println("La fecha de inicio antes de la operación es: "
					+ b.getFechaComienzo());
			System.out.println("La nueva fecha de inicio es: " + fechaComienzo);
			b.setFechaComienzo(fechaComienzo);
			System.out.println("La fecha de inicio después de la operación es: "
							+ b.getFechaComienzo());
	...
	private static void mostrarBecario(Becario b) {
		...
		System.out.println("\tFecha de inicio: <" + b.getFechaComienzo() + ">");
